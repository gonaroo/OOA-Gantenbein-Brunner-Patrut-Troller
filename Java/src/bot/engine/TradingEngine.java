...
package src.bot.engine;

import src.bot.config.exchange.ExchangeConfig;
import src.bot.config.exchange.NetworkConfig;
import src.bot.config.exchange.OptionalConfig;
import src.bot.config.market.Market;
import src.bot.config.strategy.StrategyConfig;
import src.bot.mail.EmailAlerter;
import src.bot.util.ConfigurableComponentFactory;
...
public class TradingEngine {
    ...
    private static final String CRITICAL_EMAIL_ALERT_SUBJECT = "CRITICAL Alert message from bot";
    ...
    private void loadExchangeAdapterConfig() {
        ...
        if (networkConfig != null) {
            ...
            final NetworkConfig adapterNetworkConfig = new NetworkConfig();
        ...
        if (authenticationConfig != null) {
            ...
            final AuthenticationConfig adapterAuthenticationConfig = new AuthenticationConfig();
...
//                    "AuthenticationConfiguration has been set: " + adapterAuthenticationConfig);
        ...
        if (optionalConfig != null) {
            ...
            final OptionalConfig adapterOptionalConfig = new OptionalConfig();
    ...
    private void loadMarketConfigAndInitialiseTradingStrategies() {
        ...
        for (final MarketConfig market : markets) {
            ...
            if (strategyDescriptions.containsKey(strategyToUse)) {
                ...
                final StrategyConfig tradingStrategyConfig = new StrategyConfig();
